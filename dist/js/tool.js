...
var render = function() {
  ...
  return !_vm.isEmpty || _vm.data.linkTo
    ? _c(
        "div",
        { class: [_vm.data.type, { "mb-6": _vm.isTopLevel }, "select-none"] },
        [
          _vm.data.label && _vm.isTopLevel
            ? _c(
                ...
                _vm._b(
                  {
                    staticClass:
                      "flex flex-1 items-center font-normal text-90 text-base no-underline relative",
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "span",
                        { staticClass: "flex text-90 sidebar-label" },
                        [
                          _vm._v(
                            "\n                " +
            ...
            ? [
                _vm.data.label
                  ? _c(
                      ...
                      {
                        staticClass:
                          "relative select-none ml-8 mt-4 text-xs text-90 uppercase tracking-wide cursor-pointer",
                        on: {
          ...
          resource.type === "group"
            ...
            ? _c("div", [
                _c(
                  ...
                  {
                    staticClass:
                      "relative text-90 text-left no-underline dim block",
...
module.exports = __webpack_require__(/*! /Volumes/Documents/bb_Repositories/app/igdpr/packages/aequam/CollapsibleResourceManager/resources/js/tool.js */"./resources/js/tool.js");
